...
const Room2 = () => {
  ...
  const verifyCode = () => {
    const isCorrect =
      codeInput.includes("useEffect") && codeInput.includes("useState");
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white pt-16">
      ...
      <div className="p-8 text-center relative z-0">
        <h1 className="text-2xl font-bold mb-4 text-blue-400 animate-pulse">
          Room 2: Advanced State Management
        </h1>
        <p className="mb-4">
          Welcome to Room 2! Here, you'll explore advanced state management in
          React.
        </p>
        <div className="bg-gray-800 p-4 shadow rounded mb-4">
          ...
          <ol className="list-decimal list-inside">
            <li className="mb-2">
              Create a component that fetches data using <code>useEffect</code>.
            </li>
            <li className="mb-2">
              Manage the fetched data using <code>useState</code>.
            </li>
            <li className="mb-2">
        ...
        {isCodeCorrect === true && (
          <p className="text-green-400 mb-4 animate-bounce">
            Code verified! Now proceed to Room 3.
          </p>
        )}
        {isCodeCorrect === false && (
